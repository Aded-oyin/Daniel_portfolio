...
const Home = () => {
  return (
    <div name="home" className='w-full h-screen bg-gradient-to-b from-[#0a192f] via-[#0a192f] to-slate-700'>

         <div className='max-w-[1000px] mx-auto px-20 lg:px-8 flex flex-col justify-center h-full'>
