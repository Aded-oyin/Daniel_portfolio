...
const About = () => {
  return (
    <div name="about" className='w-full h-screen bg-gradient-to-b from-slate-800 to-[#0a192f] text-gray-300'>
        <div className='flex flex-col px-10 lg:px-0 justify-center items-center w-full h-full'>
